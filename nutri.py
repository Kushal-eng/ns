...
menu_option = st.sidebar.radio("Choose an option:", ["🏠 Home", "📊 Nutrition Analysis", "🍽️ Meal Plan", "📈 Nutrient Chart"])
...
# Food intake input (only show if not on Home page)
if menu_option != "🏠 Home":
    ...
    if food_input:
        ...
        elif menu_option == "📈 Nutrient Chart":
